...
<br class="sm:hidden"/>
Place your bet first, then click <span class="text-amber-300 font-semibold">"Get Signal"</span>.
<br/>
...
{#if data.usr}
<div class="text-center text-white text-xl" style="font-family: 'Rubik', sans-serif; font-weight: 700;">
Logged in as:
...
<button aria-label="decrease" disabled={traps==1} on:click={()=>{traps = traps - 2}} class="disabled:opacity-50 cursor-pointer">
...
<button aria-label="increase" disabled={traps==7} on:click={()=>{traps = traps + 2}} class="disabled:opacity-50 cursor-pointer">
...
<div class="space-y-3 text-cyan-100 text-sm leading-relaxed">
  ...
  <div class="flex items-start gap-2">
    <span class="text-cyan-300 mt-0.5">•</span>
    <p>Signals will auto-unlock instantly after successful deposit minimum 10$ or more.</p>
  </div>
...
.logo:hover {
transform: scale(1.1);
filter: drop-shadow(0 0 14px #00aaff);
}
.hack-text {
font-family: 'Rubik', sans-serif;
font-weight: 900;
